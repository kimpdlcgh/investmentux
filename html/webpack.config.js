...
module.exports = {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
            patterns: [
                ...
                { from: "src/assets/css", to: "assets/css", noErrorOnMissing: true } // Allow missing files but copy existing ones
            ]
        }),
        ...
        new HtmlWebpackPlugin({ filename: "callback.html", template: "!!html-webpack-plugin/lib/loader.js!./src/pages/callback.html", inject: true, minify: false, hash: true, title: "Redirecting..." }),
        ...
        new HtmlWebpackPlugin({ filename: "component-daterangepicker-datatable.html", template: "!!html-webpack-plugin/lib/loader.js!./src/pages/component-daterangepicker-datatable.html", inject: true, minify: false, hash: true, title: "component-daterangepicker-datatable" }),
    ...
    devServer: {
        static: {
            ...
            serveIndex: true // Enable directory listing for debugging
        },
        port: 8080,
        open: true,
    }
