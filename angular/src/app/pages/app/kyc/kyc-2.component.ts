    ...
    template: `
                ...
                <div class="col-12 col-sm">
                    <nav aria-label="breadcrumb" class="mb-2">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active bi" aria-current="page">KYC Step 1</li>
                        </ol>
                    </nav>
                    <h5>KYC Step 1</h5>
                </div>
        ...
        <div class="container mt-3 mt-lg-4" id="main-content">
            ...
            <ul class="nav nav-pills justify-content-center mb-3">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" routerLink="/app/kyc-2">1. Basic</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" routerLink="/app/kyc-3">2. Step</a>
                </li>
            </ul>
            ...
            <div class="card adminuiux-card overflow-hidden mb-3">
                <div class="card-body ">
                    ...
                    <div class="row">
                        <div class="col">
                            <a routerLink="/app/kyc-3" class="btn btn-theme">Save and Continue</a>
                        </div>
                        <div class="col-auto">
