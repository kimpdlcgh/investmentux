...
@Component({
    selector: "app-loan-under-progress",
    standalone: true,
    imports: [],
    template: `
        <!-- breadcrumb -->
                ...
                <div class="col col-sm">
                    <nav aria-label="breadcrumb" class="mb-2">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active bi" aria-current="page">Loan Under Process</li>
                        </ol>
                    </nav>
        ...
        <div class="container mt-4" id="main-content">
            ...
            <div class="row align-items-center mb-3">
                <div class="col-3 col-sm-auto mb-3 mb-sm-0">
            ...
            <div class="row gx-2 text-center align-items-center justify-content-between mb-3">
                <div class="col col-sm-auto py-3">
                    <i class="bi bi-check-circle-fill h3 text-success mb-3"></i>
                    <p class="text-success">Applied Loan</p>
                </div>
                <div class="col col-sm-auto py-0 py-sm-3">
                    <i class="bi bi-arrow-right h4 text-theme-1"></i>
                </div>
                <div class="col col-sm-auto py-3">
                    <i class="bi bi-check-circle-fill h3 text-success mb-3"></i>
                    <p class="text-success">Eligibility Check</p>
                </div>
                <div class="col col-sm-auto py-0 py-sm-3">
                    <i class="bi bi-arrow-right h4 text-theme-1"></i>
                </div>
                <div class="col col-sm-auto py-3">
                    <i class="bi bi-check-circle-fill h3 text-success mb-3"></i>
                    <p class="text-success">Document Verification</p>
                </div>
                <div class="col col-sm-auto py-0 py-sm-3">
                    <i class="bi bi-arrow-right h4 text-theme-1"></i>
                </div>
                <div class="col col-sm-auto py-3">
                    <i class="bi bi-check-circle-fill h3 text-success mb-3"></i>
                    <p class="text-success">Loan Passed</p>
                </div>
                <div class="col col-sm-auto py-0 py-sm-3">
                    <i class="bi bi-arrow-right h4 text-theme-1"></i>
                </div>
                <div class="col col-sm-auto py-3">
                    <i class="bi bi-check-circle h3 text-secondary mb-3"></i>
                    <p class="text-secondary">Disbursement</p>
                </div>
            </div>
                    ...
                    <div class="row gx-3 gx-lg-4">
                        ...
                        <div class="col-6 col-sm-6 col-lg-6">
                            <div class="card adminuiux-card mb-3 mb-lg-4">
                                <div class="card-body z-index-1">
                                    <h4 class="fw-medium text-warning">$ 12,500.00</h4>
                                    <p><span class="text-secondary">Processing...</span></p>
                                </div>
                            </div>
                        ...
                        <div class="col-6 col-sm-6 col-lg-6">
                            <div class="card adminuiux-card theme-teal mb-3">
                                <div class="card-body z-index-1">
                                    <h4 class="fw-medium">10.15 %</h4>
                                    <p><span class="text-secondary">Interest Rate</span></p>
                                </div>
                            </div>

                            <div class="card border-theme-1 theme-teal overflow-hidden mb-3">
                                <div class="card-body bg-theme-1-subtle z-index-1">
                                    <div class="row gx-3 gx-lg-4 align-items-center">
                                        <div class="col">
                                            <h4 class="fw-medium ">12 July 2025</h4>
                                            <p><span class="text-secondary">Disbursement</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card adminuiux-card mb-3 mb-lg-4">
                        ...
                        <div class="card-body pb-0">
                            <div class="row gx-3 gx-lg-4">
                                ...
                                <div class="col-12 col-sm-6 text-sm-end mb-3">
...
export class LoanUnderProgressComponent {
