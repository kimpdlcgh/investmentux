                ...
                <div class="col col-sm">
                    <nav aria-label="breadcrumb" class="mb-2">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active bi" aria-current="page">Send Money</li>
                        </ol>
                    </nav>
                    <h5>Send Money</h5>
                </div>
            ...
            <div class="row gx-3 gx-lg-4 justify-content-center">
                <div class="col-12 col-md-8 col-lg-6 col-xxl-4">
                    <div class="card adminuiux-card mb-4">
                        <div class="card-body">
                            <!-- <p class="small text-secondary">Step 1: Default</p> -->
                            ...
                            <!--  <p class="small text-secondary">Step 2 Option 1: One contact selected</p> -->
                            <!-- <div class="card mb-3 mb-lg-4" id="onecontact">
                                <div class="card-body">
                                    <div class="row gx-3 gx-lg-4 align-items-center">
                                        <div class="col-auto">
                            ...
                            <!-- <p class="small text-secondary">Step 2 Option 2: Multiple contact selected</p> -->
                            <!--  <div class="card mb-3 mb-lg-4" id="morecontact">
                                <div class="card-body">
                                    <div class="row gx-3 gx-lg-4 align-items-center">
                            ...
                            <h6 class="mb-3">Amount to Send</h6>
                            ...
                            <div class="text-center mb-4">
                                <h5 class="fw-normal"><b class="fw-bold">Great!</b><br />You are going to send</h5>
                                <h1 class="mb-0 text-theme-1">100.00</h1>
                                <p class="text-secondary small">in Canadian Dollar</p>
                            </div>

                            <div class="alert alert-danger alert-dismissible fade show mb-3 mb-lg-4" role="alert">
                                <p class="fw-bold mb-2"><i class="bi bi-exclamation-triangle me-1"></i> Low balance!</p>
                                <p class="mb-0 small">Your wallet account does not have enough money to send. Kindly add money or choose different wallet account.</p>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>

                            <a routerLink="/app/wallet-payment-success" class="btn btn-lg btn-theme w-100">Send</a>
                        </div>
                    </div>
                </div>
            </div>
...
export class WalletSendmoneyComponent {}
